...
class CreateUserTest extends TestCase
{
    ...
    public function test_user_cannot_create_account_with_empty_credentials(): void
    {
        $payload = [
            'first_name' => '',
            'last_name' => '',
    ...
    public function test_user_cannot_create_account_with_existing_email(): void
    {
    ...
    public function test_user_can_create_account_successful(): void
    {
        $payload = [
            'first_name' => fake()->firstName(),
            'last_name' => fake()->firstName(),
